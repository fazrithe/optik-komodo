    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <table>
                ...
                <tr>
                    <th><input style="width:145px; margin-right:5px;" type="text" name="kode_brg" id="kode_brg" class="form-control input-sm"></th>                     
                </tr>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                ...
                <tbody>
                    ...
                    <tr>
                         ...
                         <td style="text-align:right;"><?php echo number_format($items['harjul_grosir']);?></td>
                         <td style="text-align:right;"><?php echo number_format($items['harjul_grosir_umum']);?></td>
