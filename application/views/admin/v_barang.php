            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center;">Harga Jual Grosir Umum</th>
                ...
                <?php 
                    ...
                    foreach ($data->result_array() as $a):
                        ...
                        $harjul_grosir_umum=$a['barang_harjul_grosir_umum'];
                        $diskon_1=$a['diskon_1'];
                        $diskon_2=$a['diskon_2'];
                        $diskon_3=$a['diskon_3'];
                        $stok=$a['barang_stok'];
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:right;"><?php echo 'Rp '.number_format($harjul_grosir_umum);?></td>
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/Barang/tambah_barang'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Harga Jual Grosir Umum</label>
                        <div class="col-xs-9">
                            <input name="harjul_grosir_umum" class="harjul form-control" type="text" placeholder="Harga Jual Grosir Umum..." style="width:335px;">
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group"> -->
                        ...
                        <!-- <div class="col-xs-9"> -->
                            <input name="diskon_1" class="diskon_1 form-control" type="hidden" placeholder="Diskon konsumen..." style="width:335px;">
                        <!-- </div> -->
                    <!-- </div> -->
                    ...
                    <!-- <div class="form-group"> -->
                        ...
                        <!-- <div class="col-xs-9"> -->
                            <input name="diskon_2" class="diskon_2 form-control" type="hidden" placeholder="Diskon toko..." style="width:335px;">
                        <!-- </div> -->
                    <!-- </div> -->
                    ...
                    <!-- <div class="form-group"> -->
                        ...
                        <!-- <div class="col-xs-9"> -->
                            <input name="diskon_3" class="diskon_3 form-control" type="hidden" placeholder="Diskon tempo..." style="width:335px;">
                        <!-- </div> -->
                    <!-- </div> -->
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/Barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Harga Jual Grosir Umum</label>
                            <div class="col-xs-9">
                                <input name="harjul_grosir_umum" class="harjul form-control" type="text" value="<?php echo $harjul_grosir_umum;?>" placeholder="Harga Jual Grosir Umum..." style="width:335px;" required>
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <!-- <div class="col-xs-9"> -->
                                <input name="diskon_1" class="diskon_1 form-control" type="hidden" value="<?php echo $diskon_1;?>" placeholder="Diskon 1..." style="width:335px;">
                            <!-- </div> -->
                        <!-- </div> -->
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <!-- <div class="col-xs-9"> -->
                                <input name="diskon_2" class="diskon_2 form-control" type="hidden" value="<?php echo $diskon_2;?>" placeholder="Diskon 2..." style="width:335px;">
                            <!-- </div> -->
                        <!-- </div> -->
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <!-- <div class="col-xs-9"> -->
                                <input name="diskon_3" class="diskon_3 form-control" type="hidden" value="<?php echo $diskon_3;?>" placeholder="Diskon 3..." style="width:335px;">
                            <!-- </div> -->
                        <!-- </div> -->
